...
var HomePage = /** @class */ (function () {
    function HomePage(todoService, alertController, navController) {
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.todoService.getTodos().then(function (data) { return _this.todos = data; });
    };
    HomePage.prototype.deleteDialog = function (producto, id) {
                            ...
                            buttons: [
                                {
                                    ...
                                    text: 'Aceptar',
                                    handler: function () {
                                        _this.todoService.deleteTodo(id).then(function () { return _this.todoService.getTodos().then(function (data) { return _this.todos = data; }); });
                                    }
                                }
                            ]
                        })];
    ...
    HomePage.prototype.editTodo = function (id) {
